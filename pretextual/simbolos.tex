\begin{simbolos}
   ...
   %\item[$d_G$] Diãmetro hidráulico da fase gás \space [$m$]
   ...
   %\item[$j_G$] Velocidade superficial da fase gás \space [$m/s$]
   %\item[$j_L$] Velocidade superficial da fase líquida \space [$m/s$]
   ...
   %\item[$q_G$] Vazão volumétrica da fase gás \space [$m^3/s$]
